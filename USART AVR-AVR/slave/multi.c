...
static const uint8_t __flash DIGITS[11] = {0x3F, 0x06, 0x9B, 0x8F, 0xA6, 0xAD, 0xBD, 0x07, 0xBF, 0xAF, 0x00};
// W powyzszych definicjach zmienione zostaly wartosci ze wzgledu na podlaczenie
// segmentu G wyswietlacza do PB7, zamiast PB6!
