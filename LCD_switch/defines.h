...
#define SWITCH_UP D, 5
#define SWITCH_DOWN D, 6
#define SWITCH_CHOOSE D, 7



#define LCD_ROWS    2        //Liczba wyswietlanych na LCD rzedów
#define LCD_COLUMNS 15       //Liczba wyswietlanych na LCD kolumn